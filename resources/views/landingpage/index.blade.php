...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
			...
			<div class="slider-item">
				...
				<div class="container-fluid px-md-0">
					<div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
						<div class="one-third order-md-last img" style="background-image:url(/../admin/images/bg_1.jpg);">
							<div class="overlay"></div>
			...
			<div class="slider-item">
				...
				<div class="container-fluid px-md-0">
					<div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
						<div class="one-third order-md-last img" style="background-image:url(/../admin/images/bg_2.jpg);">
							<div class="overlay"></div>
							<div class="overlay-1"></div>
						</div>
						<div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
			...
			<div class="row d-flex no-gutters">
				<div class="col-md-6 col-lg-5 d-flex">
					<div class="img-about img d-flex align-items-stretch">
						<div class="overlay"></div>
						<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(/../admin/images/about-1.jpg);">
						</div>
					</div>
				</div>
					...
					<div class="py-md-5">
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								...
								<p style="text-align: justify">Lulusan baru yang penuh semangat dan siap untuk membawa energi positif ke dunia
                                    profesional. Dengan latar belakang pendidikan teknik informatika, saya telah
                                    mendapatkan pemahaman yang kuat dan keterampilan praktis yang diperlukan untuk
                                    berkembang di dunia kerja.
                                    </p>

								<ul class="about-info mt-4 px-md-0 px-2">
									<li class="d-flex"><span>Nama:</span> <span>Beby Nosderita Lahagu</span></li>
									<li class="d-flex"><span>Tanggal Lahir:</span> <span>25-10-1998</span></li>
									<li class="d-flex"><span>Alamat:</span> <span>Jl. Jenggala No 59 Madrash Hulu</span></li>
									<li class="d-flex"><span>Zip code:</span> <span>20212</span></li>
									<li class="d-flex"><span>Email:</span> <span>bebynlahagu20@gmail.com</span></li>
									<li class="d-flex"><span>Phone: </span> <span>+62 823 6199 8907</span></li>
								</ul>
							</div>
							<div class="col-md-12">
	...
	<footer class="ftco-footer ftco-section">
		...
		<script src="{{ asset('admin/js/google-map.js') }}"></script>
